...
class DonHangVCJob implements ShouldQueue
{
    ...
    {
        Mail::to($this->dh->Email)->send(new MailDonHangVanChuyen($this->dh, $this->chi_tiet_dh ,$this->content,$this->title, $this->total));
    }
}
