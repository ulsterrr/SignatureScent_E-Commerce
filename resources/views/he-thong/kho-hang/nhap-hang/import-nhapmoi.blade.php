                ...
                <div class="card-header text-left bg-transparent">
                    <div class="btn-group dropdown">
                        ...
                        <div class="dropdown-menu" x-placement="right-start" style="left: 50%">
                            <a class="dropdown-item" href="{{ route('download.NhapMoi') }}">Tải mẫu</a>
                        </div>
                    </div>
                        ...
                        <table id="ul-contact-list" class="display table" style="width:100%; overflow-y: scroll">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 50%">Loại Kích cỡ</th>
    ...
    function dataToTables(data) {
        ...
        var table = $('#ul-contact-list').DataTable({
            ...
            , columnDefs: [{ width: '80px' , targets: 0 } , { width: '20%' , targets: 1 } , { width: '20%' , targets: 2 } , { width: '10%' , targets: 3 } ,
                { width: '10%' , targets: 4 } , { width: '30%' , targets: 5 } , { width: '10%' , targets: 6 } , { width: '10%' , targets: 7 } , { width: '30%' , targets: 8 } ,
                { width: '30%' , targets: 9 } , { width: '30%' , targets: 10 } , { width: '30%' , targets: 11 } , { width: '30%' , targets: 12 } , { width: '30%' , targets: 13 } , ]
            ...
            , columns: [{
                ...
                , {
                    ...
                    , render: function(data) {
                        var mota = data;
                        return `<textarea style="width: 350px" class="form-control" rows="3" name="MoTa" id="MoTa" placeholder="...">${mota}</textarea>`;
                    }
                }
                , {
                    data: 8
...
<script>
    $(document).ready(function() {
        ...
        $("#saveBtn").click(function() {
            ...
            $.ajax({
                url: "{{ route('saveImportNhapMoi') }}", // Đường dẫn xử lý lưu dữ liệu
                type: "POST"
                , data: {
                    _token: csrfToken,
                    data: data
