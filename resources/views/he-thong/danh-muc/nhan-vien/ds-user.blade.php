            ...
            <div class="card-header  gradient-purple-indigo  0-hidden pb-80">
                <div class="pt-4">
                    <div class="row">
                        ...
                        <input type="text" class="form-control form-control-rounded col-md-4 ml-3 mr-3" id="exampleFormControlInput1" placeholder="Search Contacts...">
                    </div>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="ul-contact-list">
                                        ...
                                        <!-- modal  -->
                                        <button type="button" class="btn btn-outline-secondary btn-block mb-4" data-toggle="modal" data-target="#exampleModal">
                                            ADD CONTACT
                                        </button>
                                        ...
                                        <div class="list-group" id="list-tab" role="tablist">
                                            <a class="list-group-item list-group-item-action border-0 active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">
                                                <i class="nav-icon i-Business-Mens"></i>
                                                Contact List</a>
                                            <a class="list-group-item list-group-item-action border-0" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab" aria-controls="profile">
                                                <i class="nav-icon i-Conference"></i>
                                                Conected</a>
                                            <a class="list-group-item list-group-item-action border-0" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">
