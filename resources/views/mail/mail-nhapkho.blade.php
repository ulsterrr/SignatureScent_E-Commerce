                    ...
                    <tr style="text-align: -webkit-center;">
                        ...
                        <tbody>
                          ...
                          <tr style="border: 1px solid black">
                            ...
                            <td style="border: 1px solid black">{{ $row->chiTietCuaSanPham->TenSanPham }}</td>
                            <td style="text-align: center;border: 1px solid black">{{ $row->SoSerial }}</td>
                            <td style="text-align: center;border: 1px solid black">{{ $row->chiTietCuaSanPham->loaiKichCo->TenKichCo }}</td>
                            <td style="text-align: center;border: 1px solid black">{{ $row->KichCo }}</td>
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                        <a target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;"
                                         href="{{ route('chitietSPham-view', ['id' => $msp]) }}">Bấm vào đây để xem thông tin</a>
                                    </td>
                                </tr>
                                </table>
                            </td>
