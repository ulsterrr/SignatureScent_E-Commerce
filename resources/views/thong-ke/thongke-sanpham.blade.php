                ...
                <div class="card-body">
                    <form id="searchForm" method="POST" class="mb-3 mt-0 p-3 pt-0">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <label for="created_at_from">Từ ngày</label>
                                <div class="input-group">
            ...
            , columns: [
                ...
                , {
                    ...
                    , render: function(data) {
                        let amount = data.GiaTien * data.SoLuong;
                        if(!amount) return 0;
                ...
                , footerCallback: function(row, data, start, end, display) {
                    var api = this.api();
                    var columnIndices = [2, 3]; // Các cột muốn tính tổng
...
<script>
    ...
    $('#searchForm').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('loadSanPhamThongKeFilter') }}",
            type: 'POST',
            data: {
                filter: formData,
                _token: '{{ csrf_token() }}'
