...
! function (a) {
    ...
    c.prototype.set = function (a, b, c) {
        ...
        var b = this,
            ...
            r = function () {
                var d = k.year,
                    e = c.selectYears === !0 ? 50 : ~~(c.selectYears / 2); // thay đổi range 5 thành 50, để hiện option theo năm hiện tại
                if (e) {
                    var g = m.year,
                        h = n.year,
                        i = d - e,
        ...
        return {
            ...
            closeOnSelect: !0,
            closeOnClear: !0,
            //format: "d mmmm, yyyy", format mặc định cũ của js
            format: "dd/mm/yyyy", // format mới theo type VN định nghĩa cho app
            klass: {
                table: a + "table",
                header: a + "header",
                navPrev: a + "nav--prev",
